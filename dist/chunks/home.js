...
class EmptyPlaceholder extends s {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_1dda6cea, _rumious_ctx_22f3049a) {
      ...
      window.RUMIOUS_JSX.dynamicValue(_rumious_el2, _rumious_dymanic_, this.props.icon ?? "inbox", _rumious_ctx_22f3049a);
      ...
      window.RUMIOUS_JSX.dynamicValue(_rumious_el3, _rumious_dymanic_2, this.props.content ?? "No content here", _rumious_ctx_22f3049a);
      _rumious_el.appendChild(_rumious_el3);
      _rumious_el.appendChild(document.createTextNode("\n      "));
      _rumious_root_1dda6cea.appendChild(_rumious_el);
      return _rumious_root_1dda6cea;
    });
  }
}
...
class SelectCanvasModeModal extends s {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_2c8d6227, _rumious_ctx_41fe4a9f) {
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el, _rumious_ctx_41fe4a9f, "ref", "standalone", this.modalRef);
      _rumious_el.appendChild(document.createTextNode("\n          "));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el5, _rumious_ctx_41fe4a9f, "on", "click", () => this.closeModal());
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el9, _rumious_ctx_41fe4a9f, "model", "standalone", this.currentType);
      _rumious_el9.appendChild(document.createTextNode("\n                  "));
      const _rumious_dymanic_ = document.createTextNode("");
      _rumious_el9.appendChild(_rumious_dymanic_);
      window.RUMIOUS_JSX.dynamicValue(_rumious_el9, _rumious_dymanic_, Object.entries(CANVAS_MODES).map(([key, label]) => window.RUMIOUS_JSX.template(function (_rumious_root_95a2adf1, _rumious_ctx_733c194e) {
        ...
        window.RUMIOUS_JSX.dynamicValue(_rumious_el13, _rumious_dymanic_2, label, _rumious_ctx_733c194e);
        _rumious_root_95a2adf1.appendChild(_rumious_el13);
        return _rumious_root_95a2adf1;
      })), _rumious_ctx_41fe4a9f);
      _rumious_el9.appendChild(document.createTextNode("\n                "));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el12, _rumious_ctx_41fe4a9f, "on", "click", () => this.onDoneBtnClick());
      ...
      _rumious_frag.appendChild(document.createTextNode("\n      "));
      _rumious_root_2c8d6227.appendChild(_rumious_frag);
      return _rumious_root_2c8d6227;
    });
  }
}
...
class CanvasTextEditor extends s {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_3237bb6d, _rumious_ctx_3e2abae1) {
      const _rumious_frag = document.createDocumentFragment();
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el3, _rumious_ctx_3e2abae1, "bind", "text", this.currentState);
      _rumious_el.appendChild(_rumious_el3);
      _rumious_el.appendChild(document.createTextNode("\n        "));
      _rumious_frag.appendChild(_rumious_el);
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el6, _rumious_ctx_3e2abae1, "ref", "standalone", this.textAreaRef);
      window.RUMIOUS_JSX.addDirective(_rumious_el6, _rumious_ctx_3e2abae1, "on", "change", () => this.onTextInputChange());
      _rumious_el6.setAttribute("style", "width:100%; height:50vh;");
      _rumious_frag.appendChild(_rumious_el6);
      _rumious_frag.appendChild(document.createTextNode("\n      "));
      _rumious_root_3237bb6d.appendChild(_rumious_frag);
      return _rumious_root_3237bb6d;
    });
  }
}
...
class Canvas extends s {
  ...
  addObject(data) {
    ...
    switch (data) {
      case "text":
        this.canvasContentRef.addChild(this.render(window.RUMIOUS_JSX.template(function (_rumious_root_3c5ab58a, _rumious_ctx_82423d6d) {
          const _rumious_el = window.RUMIOUS_JSX.createComponent(CanvasTextEditor);
          _rumious_el.setup(_rumious_ctx_82423d6d, CanvasTextEditor);
          _rumious_el.props["context"] = this.props.context;
          _rumious_root_3c5ab58a.appendChild(_rumious_el);
          return _rumious_root_3c5ab58a;
        })));
        break;
    }
  }
  ...
  onChangeBtnClick() {
    this.warp(window.RUMIOUS_JSX.template(function (_rumious_root_383a190c, _rumious_ctx_01c78b77) {
      const _rumious_el2 = window.RUMIOUS_JSX.createComponent(SelectCanvasModeModal);
      _rumious_el2.setup(_rumious_ctx_01c78b77, SelectCanvasModeModal);
      _rumious_el2.props["context"] = this.props.context;
      _rumious_root_383a190c.appendChild(_rumious_el2);
      return _rumious_root_383a190c;
    }), document.body);
  }
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_0c16226b, _rumious_ctx_5aae48ae) {
      const _rumious_frag = document.createDocumentFragment();
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      const _rumious_el3 = document.createElement("div");
      window.RUMIOUS_JSX.addDirective(_rumious_el3, _rumious_ctx_5aae48ae, "ref", "standalone", this.canvasRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el6, _rumious_ctx_5aae48ae, "on", "click", () => this.onChangeBtnClick());
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el7, _rumious_ctx_5aae48ae, "on", "click", () => this.element.classList.remove("open"));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el9, _rumious_ctx_5aae48ae, "ref", "standalone", this.emptyPlaceholder);
      _rumious_el9.appendChild(document.createTextNode("\n            "));
      const _rumious_el10 = window.RUMIOUS_JSX.createComponent(EmptyPlaceholder);
      _rumious_el10.setup(_rumious_ctx_5aae48ae, EmptyPlaceholder);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el11, _rumious_ctx_5aae48ae, "ref", "standalone", this.canvasContentRef);
      _rumious_el8.appendChild(_rumious_el11);
      _rumious_el8.appendChild(document.createTextNode("\n        "));
      _rumious_frag.appendChild(_rumious_el8);
      _rumious_frag.appendChild(document.createTextNode("\n      "));
      _rumious_root_0c16226b.appendChild(_rumious_frag);
      return _rumious_root_0c16226b;
    });
  }
}
...
class TakePhotoModal extends s {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_f869983d, _rumious_ctx_7ca685ef) {
      const _rumious_frag = document.createDocumentFragment();
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      const _rumious_el = document.createElement("div");
      _rumious_el.setAttribute("class", "modal");
      window.RUMIOUS_JSX.addDirective(_rumious_el, _rumious_ctx_7ca685ef, "ref", "standalone", this.modalRef);
      _rumious_el.appendChild(document.createTextNode("\n          "));
      const _rumious_el2 = document.createElement("div");
      _rumious_el2.setAttribute("class", "modal-content");
      _rumious_el2.appendChild(document.createTextNode("\n            "));
      ...
      _rumious_el3.appendChild(document.createTextNode("\n              "));
      const _rumious_el5 = document.createElement("button");
      window.RUMIOUS_JSX.addDirective(_rumious_el5, _rumious_ctx_7ca685ef, "on", "click", () => this.closeModal());
      _rumious_el5.setAttribute("class", "ml-auto btn btn-icon material-icons");
      _rumious_el5.appendChild(document.createTextNode("close"));
      _rumious_el3.appendChild(_rumious_el5);
      _rumious_el3.appendChild(document.createTextNode("\n            "));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el7, _rumious_ctx_7ca685ef, "ref", "standalone", this.videoRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el8, _rumious_ctx_7ca685ef, "ref", "standalone", this.canvasRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el10, _rumious_ctx_7ca685ef, "on", "click", () => this.capturePhoto());
      ...
      _rumious_frag.appendChild(_rumious_el);
      _rumious_frag.appendChild(document.createTextNode("\n      "));
      _rumious_root_f869983d.appendChild(_rumious_frag);
      return _rumious_root_f869983d;
    });
  }
}
...
class ChatBox extends s {
  ...
  addNote(msg) {
    this.listMsg.addChild(this.render(window.RUMIOUS_JSX.template(function (_rumious_root_341160c5, _rumious_ctx_d30a7b7b) {
      const _rumious_el = document.createElement("div");
      _rumious_el.setAttribute("class", "divider divider-text");
      _rumious_el.appendChild(document.createTextNode("\n        "));
      const _rumious_dymanic_ = document.createTextNode("");
      _rumious_el.appendChild(_rumious_dymanic_);
      window.RUMIOUS_JSX.dynamicValue(_rumious_el, _rumious_dymanic_, msg, _rumious_ctx_d30a7b7b);
      _rumious_el.appendChild(document.createTextNode("\n      "));
      _rumious_root_341160c5.appendChild(_rumious_el);
      return _rumious_root_341160c5;
    })));
    this.emptyPlaceholder.addClasses("d-none");
    this.scrollToBottom();
  }
  addMessage(msg) {
    this.listMsg.addChild(this.render(window.RUMIOUS_JSX.template(function (_rumious_root_3e96a3b3, _rumious_ctx_191e17e9) {
      const _rumious_el2 = document.createElement("div");
      ...
      window.RUMIOUS_JSX.dynamicValue(_rumious_el6, _rumious_dymanic_2, msg.sender.name, _rumious_ctx_191e17e9);
      _rumious_el5.appendChild(_rumious_el6);
      _rumious_el5.appendChild(document.createTextNode("\n            "));
      ...
      window.RUMIOUS_JSX.dynamicValue(_rumious_el7, _rumious_dymanic_3, msg.sender.role, _rumious_ctx_191e17e9);
      _rumious_el5.appendChild(_rumious_el7);
      _rumious_el5.appendChild(document.createTextNode("\n          "));
      _rumious_el3.appendChild(_rumious_el5);
      _rumious_el3.appendChild(document.createTextNode("\n        "));
      ...
      window.RUMIOUS_JSX.dynamicValue(_rumious_el8, _rumious_dymanic_4, msg.contents.map(item => window.RUMIOUS_JSX.template(function (_rumious_root_be21b133, _rumious_ctx_e047f68e) {
        const _rumious_el9 = document.createElement("span");
        window.RUMIOUS_JSX.addDirective(_rumious_el9, _rumious_ctx_e047f68e, "inject", "standalone", u(marked.parse(item)));
        _rumious_root_be21b133.appendChild(_rumious_el9);
        return _rumious_root_be21b133;
      })), _rumious_ctx_191e17e9);
      _rumious_el8.appendChild(document.createTextNode("\n        "));
      _rumious_el2.appendChild(_rumious_el8);
      _rumious_el2.appendChild(document.createTextNode("\n      "));
      _rumious_root_3e96a3b3.appendChild(_rumious_el2);
      return _rumious_root_3e96a3b3;
    })));
    this.emptyPlaceholder.addClasses("d-none");
    this.scrollToBottom();
  }
  takePhoto() {
    this.warp(window.RUMIOUS_JSX.template(function (_rumious_root_1afdae89, _rumious_ctx_dce7424c) {
      const _rumious_el10 = window.RUMIOUS_JSX.createComponent(TakePhotoModal);
      _rumious_el10.setup(_rumious_ctx_dce7424c, TakePhotoModal);
      _rumious_el10.props["context"] = this.props.context;
      _rumious_root_1afdae89.appendChild(_rumious_el10);
      return _rumious_root_1afdae89;
    }), document.body);
  }
  scrollToBottom() {
  ...
  attachedImage(data) {
    ...
    this.attachedContentRef.addChild(this.render(window.RUMIOUS_JSX.template(function (_rumious_root_74f57965, _rumious_ctx_c87a1ec0) {
      const _rumious_el11 = document.createElement("img");
      _rumious_el11.setAttribute("src", data);
      _rumious_root_74f57965.appendChild(_rumious_el11);
      return _rumious_root_74f57965;
    })));
  }
  onCreate() {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_1aa1494c, _rumious_ctx_72106f41) {
      const _rumious_frag = document.createDocumentFragment();
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      const _rumious_el12 = document.createElement("div");
      window.RUMIOUS_JSX.addDirective(_rumious_el12, _rumious_ctx_72106f41, "ref", "standalone", this.headerRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el15, _rumious_ctx_72106f41, "on", "click", () => this.takePhoto());
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el17, _rumious_ctx_72106f41, "on", "click", () => this.props.context.emit("canvas:open", null));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el18, _rumious_ctx_72106f41, "ref", "standalone", this.listMsg);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el19, _rumious_ctx_72106f41, "ref", "standalone", this.emptyPlaceholder);
      _rumious_el19.appendChild(document.createTextNode("\n            "));
      const _rumious_el20 = window.RUMIOUS_JSX.createComponent(EmptyPlaceholder);
      _rumious_el20.setup(_rumious_ctx_72106f41, EmptyPlaceholder);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el22, _rumious_ctx_72106f41, "ref", "standalone", this.attachedContentRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el24, _rumious_ctx_72106f41, "on", "click", () => this.takePhoto());
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el25, _rumious_ctx_72106f41, "ref", "standalone", this.messageRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el26, _rumious_ctx_72106f41, "on", "click", () => this.onSendBtnClick());
      ...
      _rumious_frag.appendChild(document.createTextNode("\n    "));
      _rumious_root_1aa1494c.appendChild(_rumious_frag);
      return _rumious_root_1aa1494c;
    });
  }
}
...
class Page extends s {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_f1d7e038, _rumious_ctx_08977996) {
      const _rumious_frag = document.createDocumentFragment();
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      const _rumious_el = document.createElement("div");
      ...
      _rumious_el3.setup(_rumious_ctx_08977996, ChatBox);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el4, _rumious_ctx_08977996, "ref", "standalone", this.embedElement);
      ...
      _rumious_el5.setup(_rumious_ctx_08977996, Canvas);
      ...
      _rumious_frag.appendChild(_rumious_el);
      _rumious_frag.appendChild(document.createTextNode("\n      "));
      _rumious_root_f1d7e038.appendChild(_rumious_frag);
      return _rumious_root_f1d7e038;
    });
  }
}
