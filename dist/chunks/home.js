...
class EmptyPlaceholder extends s {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_12a89fcf, _rumious_ctx_ad7e204e) {
      ...
      window.RUMIOUS_JSX.dynamicValue(_rumious_el2, _rumious_dymanic_, this.props.icon ?? "inbox", _rumious_ctx_ad7e204e);
      ...
      window.RUMIOUS_JSX.dynamicValue(_rumious_el3, _rumious_dymanic_2, this.props.content ?? "No content here", _rumious_ctx_ad7e204e);
      _rumious_el.appendChild(_rumious_el3);
      _rumious_el.appendChild(document.createTextNode("\n      "));
      _rumious_root_12a89fcf.appendChild(_rumious_el);
      return _rumious_root_12a89fcf;
    });
  }
}
...
class SelectCanvasModeModal extends s {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_dfe950c0, _rumious_ctx_f3a28f02) {
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el, _rumious_ctx_f3a28f02, "ref", "standalone", this.modalRef);
      _rumious_el.appendChild(document.createTextNode("\n          "));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el5, _rumious_ctx_f3a28f02, "on", "click", () => this.closeModal());
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el9, _rumious_ctx_f3a28f02, "model", "standalone", this.currentType);
      _rumious_el9.appendChild(document.createTextNode("\n                  "));
      const _rumious_dymanic_ = document.createTextNode("");
      _rumious_el9.appendChild(_rumious_dymanic_);
      window.RUMIOUS_JSX.dynamicValue(_rumious_el9, _rumious_dymanic_, Object.entries(CANVAS_MODES).map(([key, label]) => window.RUMIOUS_JSX.template(function (_rumious_root_6a31188c, _rumious_ctx_d3f6b894) {
        ...
        window.RUMIOUS_JSX.dynamicValue(_rumious_el13, _rumious_dymanic_2, label, _rumious_ctx_d3f6b894);
        _rumious_root_6a31188c.appendChild(_rumious_el13);
        return _rumious_root_6a31188c;
      })), _rumious_ctx_f3a28f02);
      _rumious_el9.appendChild(document.createTextNode("\n                "));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el12, _rumious_ctx_f3a28f02, "on", "click", () => this.onDoneBtnClick());
      ...
      _rumious_frag.appendChild(document.createTextNode("\n      "));
      _rumious_root_dfe950c0.appendChild(_rumious_frag);
      return _rumious_root_dfe950c0;
    });
  }
}
...
class CanvasTextEditor extends s {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_87fc1ec0, _rumious_ctx_75842fd4) {
      const _rumious_frag = document.createDocumentFragment();
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el3, _rumious_ctx_75842fd4, "bind", "text", this.currentState);
      _rumious_el.appendChild(_rumious_el3);
      _rumious_el.appendChild(document.createTextNode("\n        "));
      _rumious_frag.appendChild(_rumious_el);
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el6, _rumious_ctx_75842fd4, "ref", "standalone", this.textAreaRef);
      window.RUMIOUS_JSX.addDirective(_rumious_el6, _rumious_ctx_75842fd4, "on", "change", () => this.onTextInputChange());
      _rumious_el6.setAttribute("style", "width:100%; height:50vh;");
      _rumious_frag.appendChild(_rumious_el6);
      _rumious_frag.appendChild(document.createTextNode("\n      "));
      _rumious_root_87fc1ec0.appendChild(_rumious_frag);
      return _rumious_root_87fc1ec0;
    });
  }
}
...
class Canvas extends s {
  ...
  addObject(data) {
    ...
    switch (data) {
      case "text":
        this.canvasContentRef.addChild(this.render(window.RUMIOUS_JSX.template(function (_rumious_root_33fd45a3, _rumious_ctx_0c44eac8) {
          const _rumious_el = window.RUMIOUS_JSX.createComponent(CanvasTextEditor);
          _rumious_el.setup(_rumious_ctx_0c44eac8, CanvasTextEditor);
          _rumious_el.props["context"] = this.props.context;
          _rumious_root_33fd45a3.appendChild(_rumious_el);
          return _rumious_root_33fd45a3;
        })));
        break;
    }
  }
  ...
  onChangeBtnClick() {
    this.warp(window.RUMIOUS_JSX.template(function (_rumious_root_69c882ac, _rumious_ctx_8368a1cd) {
      const _rumious_el2 = window.RUMIOUS_JSX.createComponent(SelectCanvasModeModal);
      _rumious_el2.setup(_rumious_ctx_8368a1cd, SelectCanvasModeModal);
      _rumious_el2.props["context"] = this.props.context;
      _rumious_root_69c882ac.appendChild(_rumious_el2);
      return _rumious_root_69c882ac;
    }), document.body);
  }
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_735f8f33, _rumious_ctx_7d32bb1a) {
      const _rumious_frag = document.createDocumentFragment();
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      const _rumious_el3 = document.createElement("div");
      window.RUMIOUS_JSX.addDirective(_rumious_el3, _rumious_ctx_7d32bb1a, "ref", "standalone", this.canvasRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el6, _rumious_ctx_7d32bb1a, "on", "click", () => this.onChangeBtnClick());
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el7, _rumious_ctx_7d32bb1a, "on", "click", () => this.element.classList.remove("open"));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el9, _rumious_ctx_7d32bb1a, "ref", "standalone", this.emptyPlaceholder);
      _rumious_el9.appendChild(document.createTextNode("\n            "));
      const _rumious_el10 = window.RUMIOUS_JSX.createComponent(EmptyPlaceholder);
      _rumious_el10.setup(_rumious_ctx_7d32bb1a, EmptyPlaceholder);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el11, _rumious_ctx_7d32bb1a, "ref", "standalone", this.canvasContentRef);
      _rumious_el8.appendChild(_rumious_el11);
      _rumious_el8.appendChild(document.createTextNode("\n        "));
      _rumious_frag.appendChild(_rumious_el8);
      _rumious_frag.appendChild(document.createTextNode("\n      "));
      _rumious_root_735f8f33.appendChild(_rumious_frag);
      return _rumious_root_735f8f33;
    });
  }
}
...
class TakePhotoModal extends s {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_ffecaa8c, _rumious_ctx_1868ee68) {
      const _rumious_frag = document.createDocumentFragment();
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      const _rumious_el = document.createElement("div");
      _rumious_el.setAttribute("class", "modal");
      window.RUMIOUS_JSX.addDirective(_rumious_el, _rumious_ctx_1868ee68, "ref", "standalone", this.modalRef);
      _rumious_el.appendChild(document.createTextNode("\n          "));
      const _rumious_el2 = document.createElement("div");
      _rumious_el2.setAttribute("class", "modal-content");
      _rumious_el2.appendChild(document.createTextNode("\n            "));
      ...
      _rumious_el3.appendChild(document.createTextNode("\n              "));
      const _rumious_el5 = document.createElement("button");
      window.RUMIOUS_JSX.addDirective(_rumious_el5, _rumious_ctx_1868ee68, "on", "click", () => this.closeModal());
      _rumious_el5.setAttribute("class", "ml-auto btn btn-icon material-icons");
      _rumious_el5.appendChild(document.createTextNode("close"));
      _rumious_el3.appendChild(_rumious_el5);
      _rumious_el3.appendChild(document.createTextNode("\n            "));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el7, _rumious_ctx_1868ee68, "ref", "standalone", this.videoRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el8, _rumious_ctx_1868ee68, "ref", "standalone", this.canvasRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el10, _rumious_ctx_1868ee68, "on", "click", () => this.capturePhoto());
      ...
      _rumious_frag.appendChild(_rumious_el);
      _rumious_frag.appendChild(document.createTextNode("\n      "));
      _rumious_root_ffecaa8c.appendChild(_rumious_frag);
      return _rumious_root_ffecaa8c;
    });
  }
}
...
class ChatBox extends s {
  ...
  addNote(msg) {
    this.listMsg.addChild(this.render(window.RUMIOUS_JSX.template(function (_rumious_root_5b47d0aa, _rumious_ctx_c027ebcc) {
      const _rumious_el = document.createElement("div");
      _rumious_el.setAttribute("class", "divider divider-text");
      _rumious_el.appendChild(document.createTextNode("\n        "));
      const _rumious_dymanic_ = document.createTextNode("");
      _rumious_el.appendChild(_rumious_dymanic_);
      window.RUMIOUS_JSX.dynamicValue(_rumious_el, _rumious_dymanic_, msg, _rumious_ctx_c027ebcc);
      _rumious_el.appendChild(document.createTextNode("\n      "));
      _rumious_root_5b47d0aa.appendChild(_rumious_el);
      return _rumious_root_5b47d0aa;
    })));
    this.emptyPlaceholder.addClasses("d-none");
    this.scrollToBottom();
  }
  addMessage(msg) {
    this.listMsg.addChild(this.render(window.RUMIOUS_JSX.template(function (_rumious_root_f1f702d5, _rumious_ctx_fa254597) {
      const _rumious_el2 = document.createElement("div");
      ...
      window.RUMIOUS_JSX.dynamicValue(_rumious_el6, _rumious_dymanic_2, msg.sender.name, _rumious_ctx_fa254597);
      _rumious_el5.appendChild(_rumious_el6);
      _rumious_el5.appendChild(document.createTextNode("\n            "));
      ...
      window.RUMIOUS_JSX.dynamicValue(_rumious_el7, _rumious_dymanic_3, msg.sender.role, _rumious_ctx_fa254597);
      _rumious_el5.appendChild(_rumious_el7);
      _rumious_el5.appendChild(document.createTextNode("\n          "));
      _rumious_el3.appendChild(_rumious_el5);
      _rumious_el3.appendChild(document.createTextNode("\n        "));
      ...
      window.RUMIOUS_JSX.dynamicValue(_rumious_el8, _rumious_dymanic_4, msg.contents.map(item => window.RUMIOUS_JSX.template(function (_rumious_root_816dcf15, _rumious_ctx_36fef69b) {
        const _rumious_el9 = document.createElement("span");
        window.RUMIOUS_JSX.addDirective(_rumious_el9, _rumious_ctx_36fef69b, "inject", "standalone", u(marked.parse(item)));
        _rumious_root_816dcf15.appendChild(_rumious_el9);
        return _rumious_root_816dcf15;
      })), _rumious_ctx_fa254597);
      _rumious_el8.appendChild(document.createTextNode("\n        "));
      _rumious_el2.appendChild(_rumious_el8);
      _rumious_el2.appendChild(document.createTextNode("\n      "));
      _rumious_root_f1f702d5.appendChild(_rumious_el2);
      return _rumious_root_f1f702d5;
    })));
    this.emptyPlaceholder.addClasses("d-none");
    this.scrollToBottom();
  }
  takePhoto() {
    this.warp(window.RUMIOUS_JSX.template(function (_rumious_root_b67e6203, _rumious_ctx_986f6431) {
      const _rumious_el10 = window.RUMIOUS_JSX.createComponent(TakePhotoModal);
      _rumious_el10.setup(_rumious_ctx_986f6431, TakePhotoModal);
      _rumious_el10.props["context"] = this.props.context;
      _rumious_root_b67e6203.appendChild(_rumious_el10);
      return _rumious_root_b67e6203;
    }), document.body);
  }
  scrollToBottom() {
  ...
  attachedImage(data) {
    ...
    this.attachedContentRef.addChild(this.render(window.RUMIOUS_JSX.template(function (_rumious_root_372c8a32, _rumious_ctx_d8f128ef) {
      const _rumious_el11 = document.createElement("img");
      _rumious_el11.setAttribute("src", data);
      _rumious_root_372c8a32.appendChild(_rumious_el11);
      return _rumious_root_372c8a32;
    })));
  }
  onCreate() {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_6dc9bb04, _rumious_ctx_98a85a5b) {
      const _rumious_frag = document.createDocumentFragment();
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      const _rumious_el12 = document.createElement("div");
      window.RUMIOUS_JSX.addDirective(_rumious_el12, _rumious_ctx_98a85a5b, "ref", "standalone", this.headerRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el15, _rumious_ctx_98a85a5b, "on", "click", () => this.takePhoto());
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el17, _rumious_ctx_98a85a5b, "on", "click", () => this.props.context.emit("canvas:open", null));
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el18, _rumious_ctx_98a85a5b, "ref", "standalone", this.listMsg);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el19, _rumious_ctx_98a85a5b, "ref", "standalone", this.emptyPlaceholder);
      _rumious_el19.appendChild(document.createTextNode("\n            "));
      const _rumious_el20 = window.RUMIOUS_JSX.createComponent(EmptyPlaceholder);
      _rumious_el20.setup(_rumious_ctx_98a85a5b, EmptyPlaceholder);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el22, _rumious_ctx_98a85a5b, "ref", "standalone", this.attachedContentRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el24, _rumious_ctx_98a85a5b, "on", "click", () => this.takePhoto());
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el25, _rumious_ctx_98a85a5b, "ref", "standalone", this.messageRef);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el26, _rumious_ctx_98a85a5b, "on", "click", () => this.onSendBtnClick());
      ...
      _rumious_frag.appendChild(document.createTextNode("\n    "));
      _rumious_root_6dc9bb04.appendChild(_rumious_frag);
      return _rumious_root_6dc9bb04;
    });
  }
}
...
class Page extends s {
  ...
  template() {
    return window.RUMIOUS_JSX.template(function (_rumious_root_b99fedbd, _rumious_ctx_5bd56c52) {
      const _rumious_frag = document.createDocumentFragment();
      _rumious_frag.appendChild(document.createTextNode("\n        "));
      const _rumious_el = document.createElement("div");
      ...
      _rumious_el3.setup(_rumious_ctx_5bd56c52, ChatBox);
      ...
      window.RUMIOUS_JSX.addDirective(_rumious_el4, _rumious_ctx_5bd56c52, "ref", "standalone", this.embedElement);
      ...
      _rumious_el5.setup(_rumious_ctx_5bd56c52, Canvas);
      ...
      _rumious_frag.appendChild(_rumious_el);
      _rumious_frag.appendChild(document.createTextNode("\n      "));
      _rumious_root_b99fedbd.appendChild(_rumious_frag);
      return _rumious_root_b99fedbd;
    });
  }
}
